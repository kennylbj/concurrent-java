 ...
 * any connection connect to this channel will generate a Accept Event and be handled
 * in loop body.
 * We don't handle any other events because these events may need a high-level
